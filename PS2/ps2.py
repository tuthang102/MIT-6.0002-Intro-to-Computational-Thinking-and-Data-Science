...
d = g.get_edges_for_node(Node('32'))
print(type(d[1].get_source().get_name()))
for node in d:
    print(node.get_source(), node.get_destination(), type(node.get_total_distance()))
nod = g.nodes
a = Node('123123')
print(a in nod)
print(d[1].get_total_distance())
